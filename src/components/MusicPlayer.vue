...
<script setup>
    ...
    onMounted(() => {
        let slider = document.querySelector(".volume-controls .vs-slider--circles")
...
<style>
    ...
    .track-slider .con-vs-slider {
        width: 700px;
        min-width: unset !important;
    }

    .volume-controls .con-vs-slider {
...
<style>
    ...
    .volume-controls .vs-slider--circle-text {
        font-family: Quicksand, 'sans-serif';
        font-weight: 800;
    }

    .volume-controls #slider-toggle {
    ...
    .volume-controls:hover #slider-toggle {
        border: 2px solid rgb(250, 205, 102) !important;
        background-color: #ffffff;
    }

    .volume-controls .vs-slider, .track-slider .vs-slider {
        background: rgba(255, 255, 255, 0.24) !important;
        border-radius: 42px !important;
        transition: 0.3s ease all;
    }

    .track-slider .vs-slider {
        background: rgba(255, 255, 255, 0.1) !important;
    }

    .volume-controls .vs-slider-line-one, .volume-controls .vs-slider-line-two, .volume-controls .vs-slider-line-effect {
        transition: 0.3s ease all;
    }

    .volume-controls .vs-slider-line-one {
        border-radius: 42px;
    }

    .track-slider .text-circle-slider {
        display: none;
    }
</style>