    ...
    <div class="player pt-5 pb-3 px-20 fixed bottom-0 w-full z-50 flex justify-between">
      ...
      <div class="flex flex-col items-center justify-center">
        <div class="flex gap-8 items-center mb-2">
            ...
            <span class="cursor-pointer bg-brand-yellow rounded-full w-9 h-9 flex justify-center items-center p-2 group border-[3px] border-transparent hover:bg-white hover:border-brand-yellow duration-300 ease-linear shadow-[0px_0px_18px_rgba(255,255,255,0.3)]">
