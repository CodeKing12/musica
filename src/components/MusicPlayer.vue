<template>
    <div class="player py-5 px-28 fixed bottom-0 w-full z-50 flex justify-between">
...
<script setup>
    ...
    onMounted(() => {
        let slider = document.querySelector(".vs-slider--circles")
...
<style>
    ...
    .volume-controls .vs-slider-line-one, .vs-slider-line-two, .vs-slider-line-effect {
        transition: 0.3s ease all;
    }
